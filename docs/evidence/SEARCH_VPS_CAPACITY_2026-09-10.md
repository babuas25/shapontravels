...
The fixture has 2,184 source offers and 2,177 baseline retained offers. Results do not establish capacity for the earlier 7,207-offer case, simultaneous cleanup backlog, long supplier requests, different passenger/route sizes or sustained traffic. No concurrency limit or queue has been selected or deployed solely from this fixture.
